...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "Sector Industrial",
    name: "Formu-Diel",
    type: "Aceite dieléctrico para equipos eléctricos",
    short: "Aislamiento y refrigeración en transformadores y equipos eléctricos.",
    image: "/products/aceite-dielectrico.jpg",
    solves:
      "Los transformadores y equipos eléctricos necesitan un fluido que aísle, refrigere y resista oxidación sin comprometer el dieléctrico. Formu-Diel es un aceite dieléctrico mineral altamente refinado, formulado para aislamiento y transferencia de calor en operación continua.",
    benefits: [
      "Alta rigidez dieléctrica para aislamiento eléctrico",
      "Estabilidad térmica y a la oxidación",
      "Baja tendencia a la formación de lodos",
      "Refrigeración del núcleo y los bobinados",
      "Compatible con papeles y barnices de uso eléctrico",
    ],
    applications: [
      "Transformadores de potencia y distribución",
      "Interruptores y equipos de maniobra",
      "Reconectadores y reguladores",
      "Cables y equipos de alta tensión",
    ],
    specs: [
      { label: "Aspecto visual", value: "Líquido claro, libre de material en suspensión" },
      { label: "Viscosidad cinemática @ 40 °C", value: "8 – 12 cSt" },
      { label: "Gravedad específica", value: "0,86 – 0,89" },
      { label: "Punto de inflamación", value: "> 140 °C" },
      { label: "Rigidez dieléctrica", value: "> 30 kV" },
      { label: "Contenido de agua", value: "< 30 ppm" },
    ],
    presentations: packStandard,
    datasheet: "/fichas/formu-diel.pdf",
    note: "La referencia se selecciona con el tipo de equipo, la tensión de operación y el mantenimiento del dieléctrico. Consulte la hoja de seguridad y use el equipo de protección personal recomendado.",
    seoTitle: "Formu-Diel | Aceite dieléctrico para equipos eléctricos",
    seoDescription:
      "Formu-Diel: aceite dieléctrico FormuTech para transformadores y equipos eléctricos. Aislamiento, refrigeración y ficha técnica descargable.",
  },
  {
    slug: "formulub-mw70",
...
export const oilGasProducts: Product[] = [
  ...
  },
  {
    ...
    category: "Oil & Gas",
    name: "Formu-NanoClay",
    type: "Nanoinhibidor de arcillas para fluidos de perforación",
    short: "Inhibición de arcillas reactivas con partículas de escala nano.",
    image: "/products/nanoinhibidor-arcilla.jpg",
    solves:
      "El nanoinhibidor Formu-NanoClay actúa sobre arcillas reactivas con una estructura de escala nano que mejora la cobertura de la partícula y reduce el hinchamiento. Se emplea en fluidos de perforación y de fractura cuando se busca inhibición química con baja interferencia sobre viscosidad y filtrado.",
    benefits: [
      "Inhibe la hidratación de arcillas reactivas a baja concentración",
      "Mejora la estabilidad de las paredes del pozo",
      "Puede añadirse al sistema activo sin efectos adversos sobre la viscosidad",
      "Ayuda a reducir el hinchamiento y el desmoronamiento de lutitas",
      "Es fácil de mezclar; puede ser agregado durante el bombeo",
    ],
    applications: [
      "Fluidos de perforación a base de agua",
      "Fluidos de fractura",
      "Formaciones con arcillas medianamente reactivas o muy reactivas",
    ],
    specs: [
      { label: "Apariencia", value: "Líquido ligeramente opalescente" },
      { label: "Densidad", value: "1,02 – 1,12" },
      { label: "Solubilidad en agua", value: "Dispersable" },
      { label: "pH (solución al 5 %)", value: "7,5 – 9,0" },
      { label: "Concentración recomendada", value: "2 – 4 ppb en sistemas base agua" },
    ],
    presentations: packDrumIbc,
    datasheet: "/fichas/formu-nanoclay.pdf",
    note: "La concentración puede variar según la reactividad de la lutita. Consulte la hoja de seguridad y use el equipo de protección personal recomendado.",
    highlights: [{ label: "Concentración recomendada", value: "2–4 ppb" }],
    seoTitle: "Formu-NanoClay | Nanoinhibidor de arcillas",
    seoDescription:
      "Formu-NanoClay: nanoinhibidor de arcillas FormuTech para fluidos de perforación y de fractura. Ficha técnica descargable.",
  },
  {
    slug: "mejorador-rop",
  ...
  },
  {
    ...
    category: "Oil & Gas",
    name: "Formu-Foam",
    type: "Antiespumante para fluidos de perforación y proceso",
    short: "Control de espuma en sistemas WBM y procesos de superficie.",
    image: "/products/antiespumante.jpg",
    solves:
      "La espuma en el fluido reduce la capacidad de bombeo, altera lecturas de densidad y dificulta el tratamiento en superficie. Formu-Foam es un antiespumante formulado para romper y prevenir espuma en fluidos de perforación y procesos Oil & Gas, con baja interferencia sobre las propiedades reológicas del sistema.",
    benefits: [
      "Reduce la espuma existente y limita su reaparición",
      "Ayuda a estabilizar la densidad y el nivel en tanques",
      "Compatible con sistemas WBM dispersos, semidispersos y poliméricos",
      "Puede dosificarse en el sistema activo o en superficie",
      "No induce aireación adicional del lodo",
    ],
    applications: [
      "Fluidos de perforación a base de agua",
    "Tanques de agitación y tratamiento de superficie",
      "Sistemas con tendencia a espumar por polímeros o surfactantes",
    ],
    specs: [
      { label: "Apariencia", value: "Líquido opalescente" },
      { label: "Densidad", value: "0,90 – 1,02" },
      { label: "Solubilidad en agua", value: "Dispersable" },
      { label: "pH (solución al 1 %)", value: "6,0 – 8,5" },
      { label: "Concentración recomendada", value: "0,1 – 0,5 ppb según el sistema" },
    ],
    presentations: packDrumIbc,
    datasheet: "/fichas/formu-foam.pdf",
    note: "Agregar lenta y directamente al sistema, con un flujo pequeño y constante. Consulte la hoja de seguridad y use el equipo de protección personal recomendado.",
    highlights: [{ label: "Concentración recomendada", value: "0,1–0,5 ppb" }],
    seoTitle: "Formu-Foam | Antiespumante para fluidos Oil & Gas",
    seoDescription:
      "Formu-Foam: antiespumante FormuTech para fluidos de perforación y procesos de superficie. Ficha técnica descargable.",
  },
  {
    slug: "biocida",
    ...
    category: "Oil & Gas",
    name: "Formu-BIO",
    type: "Biocida para sistemas de fluidos",
    short: "Control microbiológico en lodos y sistemas de circulación.",
    image: "/products/biocida.jpg",
    solves:
      "La actividad bacteriana en el fluido genera olores, pérdida de polímeros, corrosión y cambios de pH. Formu-BIO es un biocida para sistemas de fluidos Oil & Gas, orientado a controlar la carga microbiológica sin alterar de forma adversa la viscosidad del lodo.",
    benefits: [
      "Reduce la actividad bacteriana en el sistema de circulación",
      "Ayuda a preservar polímeros y aditivos orgánicos",
      "Limita olores y degradación del fluido",
      "Puede dosificarse de forma continua o en tratamientos batch",
      "Compatible con sistemas WBM habituales",
    ],
    applications: [
      "Fluidos de perforación a base de agua",
      "Sistemas de circulación y tanques de almacenamiento",
      "Fluidos con historial de contaminación microbiológica",
    ],
    specs: [
      { label: "Apariencia", value: "Líquido incoloro a ligeramente amarillo" },
      { label: "Densidad", value: "1,02 – 1,12" },
      { label: "Solubilidad en agua", value: "100 % soluble" },
      { label: "pH (solución al 1 %)", value: "3,5 – 6,5" },
      { label: "Concentración recomendada", value: "0,5 – 2,0 ppb según la carga biológica" },
    ],
    presentations: packDrumIbc,
    datasheet: "/fichas/formu-bio.pdf",
    note: "La dosis depende del recuento microbiológico y del tiempo de residencia del fluido. Consulte la hoja de seguridad y use el equipo de protección personal recomendado.",
    highlights: [{ label: "Concentración recomendada", value: "0,5–2 ppb" }],
    seoTitle: "Formu-BIO | Biocida para fluidos Oil & Gas",
    seoDescription:
      "Formu-BIO: biocida FormuTech para control microbiológico en fluidos de perforación. Ficha técnica descargable.",
  },
  {
    ...
    category: "Oil & Gas",
    name: "Formu-OXY",
    type: "Secuestrante de oxígeno para fluidos de proceso",
    short: "Reduce el oxígeno disuelto y limita la corrosión en el sistema.",
    image: "/products/secuestrante-oxigeno.jpg",
    solves:
      "El oxígeno disuelto acelera la corrosión de tubería, sartas y equipos de superficie. Formu-OXY es un secuestrante de oxígeno para fluidos de perforación y de proceso, formulado para reaccionar con el O₂ residual y mantener el sistema en condición reductora.",
    benefits: [
      "Reduce el oxígeno disuelto en el fluido",
      "Ayuda a proteger tubería y equipos contra corrosión por oxígeno",
      "Puede dosificarse en superficie o en el sistema activo",
      "Compatible con sistemas WBM habituales",
      "Respuesta rápida al residual de oxígeno",
    ],
    applications: [
      "Fluidos de perforación a base de agua",
      "Sistemas de inyección y circulación",
      "Fluidos de proceso con aireación en superficie",
    ],
    specs: [
      { label: "Apariencia", value: "Líquido ámbar a pardo" },
      { label: "Densidad", value: "1,20 – 1,35" },
      { label: "Solubilidad en agua", value: "100 % soluble" },
      { label: "pH (solución al 1 %)", value: "7,0 – 10,0" },
      { label: "Concentración recomendada", value: "0,1 – 0,5 ppb según el residual de O₂" },
    ],
    presentations: packDrumIbc,
    datasheet: "/fichas/formu-oxy.pdf",
    note: "La dosis se ajusta al oxígeno disuelto medido en el sistema. Consulte la hoja de seguridad y use el equipo de protección personal recomendado.",
    highlights: [{ label: "Concentración recomendada", value: "0,1–0,5 ppb" }],
...
export const industrialFamilies = [
  ...
  },
  {
    ...
    product: "Formu-Diel",
    href: "/industrial/aceite-dielectrico",
    phrase: "Aísla y refrigera el equipo eléctrico sin abrir corrosión en el dieléctrico.",
    image: "/products/aceite-dielectrico.jpg",
    facts: ["Rigidez dieléctrica > 30 kV", "Transformadores · interruptores · alta tensión"],
  },
  {
